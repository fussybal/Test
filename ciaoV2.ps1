...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('alecjanssen50@gmail.com', 'leontine50') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'alecjanssen50@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('alecjanssen50@gmail.com') #Email in which you want to receive the information
